...
class Sketch(CanvasBase):
    ...
    def Interrupt_Keyboard(self, keycode):
        ...
        self.cDict = {
            "leg1": self.components[0],
            "leg2": self.components[1],
            "leg3": self.components[2],  
            "leg4": self.components[3],  
            "leg5": self.components[4],  
            "leg6": self.components[5]   
        }
        #poses
        ...
        if keycode == ord('1'):
            ...
            if len(self.components) > -1:
                self.components[0].rotate(45, self.components[0].axisBucket[0])
            self.update()
        ...
        if keycode == ord('2'):
            ...
            if len(self.components) > 0:
                self.components[1].rotate(-30, self.components[1].axisBucket[0])
            self.update()
        ...
        if keycode == ord('3'):
            ...
            if len(self.components) > 1:
                self.components[2].rotate(60, self.components[2].axisBucket[0])
            self.update()
        ...
        if keycode == ord('4'):
            ...
            if len(self.components) > 2:
                self.components[3].rotate(-45, self.components[3].axisBucket[0])
            self.update()
